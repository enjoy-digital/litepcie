def add_artix7_timing_constraints(platform):
        platform.add_platform_command("""create_clock -name pcie_phy_clk -period 10 [get_pins -hierarchical -filter {{NAME=~*pcie_support/pcie_i/inst/inst/gt_top_i/pipe_wrapper_i/pipe_lane[0].gt_wrapper_i/gtp_channel.gtpe2_channel_i/TXOUTCLK}}]""")
...
def add_kintex7_timing_constraints(platform):
        platform.add_platform_command("""create_clock -name pcie_phy_clk -period 10 [get_pins -hierarchical -filter {{NAME=~*pcie_support/pcie_i/inst/inst/gt_top_i/pipe_wrapper_i/pipe_lane[0].gt_wrapper_i/gtx_channel.gtxe2_channel_i/TXOUTCLK}}]""")
        platform.add_platform_command("""
set_false_path -through [get_pins -hierarchical -filter {{NAME=~*/PLPHYLNKUPN}}]
set_false_path -through [get_pins -hierarchical -filter {{NAME=~*/PLRECEIVEDHOTRST}}]
set_false_path -through [get_pins -hierarchical -filter {{NAME=~*/RXELECIDLE}}]
