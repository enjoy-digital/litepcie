...
class GW5APCIEPHY(LiteXModule):
    ...
    def __init__(self, platform, pads, nlanes=1, data_width=256, pcie_data_width=256, cd="sys",
        ...
        tl_tx_ready      = Signal()
        tl_tx_data       = Signal(pcie_data_width)
        ...
        self.comb += self.swap_dwords(s_axis_tx.dat, tl_tx_data)

        # RX (HOST --> FPGA) CDC / Data Width Conversion -------------------------------------------
        tl_rx_data       = Signal(pcie_data_width)
        ...
        self.comb += [
            self.rx_datapath.source.connect(self.source),
        ...
        self.comb += self.swap_dwords(tl_rx_data, m_axis_rx.dat)
        ...
        self.ip_params.update(    
            ...
            o_PCIE_Controller_Top_pcie_tl_rx_data_o       = tl_rx_data,
            ...
            i_PCIE_Controller_Top_pcie_tl_tx_data_i       = tl_tx_data,
            ...
            i_PCIE_Controller_Top_pcie_tl_int_msinum_i    = cfg_msi.dat[:5],
        )
